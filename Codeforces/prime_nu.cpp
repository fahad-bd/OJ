...
vector<ll>isPrime(10000011,1); 
bool prime_number(ll x){
    isPrime[0]=0, isPrime[1]=0;
    for(ll i=2; i<=10000011; i+=2){
        if(i==2)continue;
        isPrime[i]=0;
    }
    for(ll i=3; i<=sqrt(10000011); i+=2){
        if(i==3)continue;
        else if(isPrime[i]==1){
            for(ll j=i*i; j<=10000011; j+=2*i){
                isPrime[j]=0;
            }
        }
    }
