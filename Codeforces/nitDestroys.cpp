...
#define stlp(it, stl)                                                   \
    ...
    cout << *it << " "
#define stlpr(it, stl)                                                     \
    for (__typeof(stl.rbegin()) it = stl.rbegin(); it != stl.rend(); it++) \
    cout << *it << " "
...
template <class T, class V>
void _print(unordered_map<T, V> &a)
{
    cerr << "[ ";
    for (auto i : a)
    {
